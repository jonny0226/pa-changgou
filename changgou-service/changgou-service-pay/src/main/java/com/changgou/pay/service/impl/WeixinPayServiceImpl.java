...
//创建com.changgou.service.impl.WeixinPayServiceImpl类
// 并发送Post请求获取预支付信息，包含二维码扫码支付地址 （这里是用httpclient模拟发送http请求 ）
@Service
public class WeixinPayServiceImpl implements WeixinPayService {
    ...
    public Map createNative(String out_trade_no, String total_fee) {
        try {
            ...
            param.put("notify_url", notifyurl);                    //回调地址  就是给微信说一声 客户支付成功之后 通过哪个地址通知微服务客户已经支付成功了
            ...
            System.out.println(content);//测试打印
